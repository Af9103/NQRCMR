...
<body>
    ...
    var message = "NQR dengan nomor ' . $reg_no . ' telah di approve oleh Supervisor(' . $nm_spv_vdd . '). Klik link ini untuk memeriksa NQR: http://e-learning.stmi.ac.id/mhs/login";
    ...
    if (isset($_POST['tolak'])) {
        ...
        if ($result_rejectspv) {
            ...
            echo '<script>
    var no_reg_sanitized = "' . preg_replace("/[^a-zA-Z0-9]+/", "", $reg_no) . '";
    var message = "NQR dengan nomor ' . $reg_no . ' telah di reject oleh foreman(' . $nm_spv_qa . ').dengan alasan ' . $remark_spv_qa . ' Klik link ini untuk memeriksa NQR: http://e-learning.stmi.ac.id/mhs/login";
