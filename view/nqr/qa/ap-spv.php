...
$queryKasir = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE YEAR(dt_op_qa) = $currentYear AND status IN (2,10) ORDER BY FIELD (status, 2,10)");
  ...
  <main id="main" class="main">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item active">
        <a class="nav-link active" aria-current="page" href="ap-spv.php">
          NQR<span style="font-size: smaller; opacity: 0.7;"> </span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="../../cmr/qa/ap-spv-cmr.php">CMR<span
          ...
          <table class="table table-hover text-center" id="dasborTable">
            ...
            <tbody>
              ...
              while ($user_data = mysqli_fetch_array($queryKasir)) {
                ...
                echo "<td class='text-center'>" . $user_data['part_no'] . "</td>"; // Menambahkan kelas CSS text-center
                ...
                echo "<td><a href='ap-spv-detail.php?Id={$user_data['Id']}'class='btn btn-info'>
