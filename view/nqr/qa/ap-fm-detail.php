...
<body>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="ap-fm.php">List NQR</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" id="myForm">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="" class="form-control" readonly value="<?php echo $qty_problem ?>">
                                    </div>
                                </div>
                                ...
                                <div class="preview-container">
                                    <div class="row">
                                        <div class="form-group col-sm-12 mb-8">
                                            <label for="fileInput" class="form-label">Attachtment (Only .pdf)</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-12 mb-8">
                                                <embed id="pdfembed" src="<?php echo "../../../file/$att"; ?>"
    ...
    if (isset($_POST['proses'])) {
        ...
        $query_approvefm = "UPDATE transaksi SET dt_fm_qa='$dt_fm_qa', nm_fm_qa='$nm_fm_qa', status='2', sts_fm_qa='1' WHERE Id='$Id'";
        $result_approvefm = mysqli_query($koneksi, $query_approvefm);

        if ($result_approvefm) {
            // Kirim notifikasi jika query update berhasil
            $message = "Pemberitahuan NQR! NQR dengan nomor $reg_no telah di approve oleh foreman QA $nm_fm_qa. Status menunggu approval supervisor.";
            $flags = "queue";
            $query_phone = "SELECT no_hp FROM isd 
                            LEFT JOIN ct_users ON ct_users.npk = isd.npk 
                            WHERE ct_users.golongan = 4 AND ct_users.acting = 2 AND dept = 'QA'";
            ...
            echo '<script>
                ...
                var message = "NQR dengan nomor ' . $reg_no . ' telah diapprove oleh foreman (' . $nm_fm_qa . '). Klik link ini untuk memeriksa NQR: http://e-learning.stmi.ac.id/mhs/login";
                ...
                Swal.fire({
                    ...
                    icon: "success",
                    title: "NQR Approved",
                    text: "NQR dengan nomor ' . $reg_no . ' telah di-approve oleh ' . $nm_fm_qa . ' pada ' . $dt_fm_qa . ' ",
    ...
    if (isset($_POST['tolak'])) {
        ...
        // Eksekusi query update
        $result_rejectfm = mysqli_query($koneksi, "UPDATE transaksi SET dt_fm_qa='$dt_fm_qa', nm_fm_qa='$nm_fm_qa', remark_fm_qa='$remark_fm_qa', remark='$remark_fm_qa', status='9',sts_fm_qa='2' WHERE Id='$Id'");
        if ($result_rejectfm) {
            // Kirim notifikasi jika query update berhasil
            $message = "Pemberitahuan NQR! NQR dengan nomor $reg_no telah di reject oleh foreman QA $nm_fm_qa dengan remark $remark_fm_qa";
            $flags = "queue";
            $query_phone = "SELECT no_hp FROM isd 
                            LEFT JOIN ct_users ON ct_users.npk = isd.npk 
            ...
            echo '<script>
    var no_reg_sanitized = "' . preg_replace("/[^a-zA-Z0-9]+/", "", $reg_no) . '";
    var message = "NQR dengan nomor ' . $reg_no . ' telah di reject oleh foreman(' . $nm_fm_qa . ').dengan alasan ' . $remark_fm_qa . ' Klik link ini untuk memeriksa NQR: http://e-learning.stmi.ac.id/mhs/login";
    ...
    Swal.fire({
        ...
        icon: "error",
        title: "NQR Rejected",
        text: "NQR dengan nomor ' . $reg_no . ' telah di-reject oleh ' . $nm_fm_qa . ' pada ' . $dt_fm_qa . ' dengan remark ' . $remark_fm_qa . '",
        showConfirmButton: false,
        timer: 2000
    }).then(() => {
        window.location.href = "ap-fm.php";
