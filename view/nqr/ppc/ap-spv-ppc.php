...
$queryKasir = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE YEAR(dt_op_qa) = $currentYear AND status_ppc IN (3,7) ORDER BY FIELD (status_ppc, 3,7)");
...
<body>
  ...
  <main id="main" class="main">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="ap-spv-ppc.php">
          NQR<span style="font-size: smaller; opacity: 0.7;"> </span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="../../cmr/ppc/ap-spv-cmr-ppc.php">CMR<span
          ...
          <table class="table table-hover text-center" id="ppcTable">
            ...
            <tbody>
              ...
              while ($user_data = mysqli_fetch_array($queryKasir)) {
                ...
                echo "<td><a href='ap-spv-detail-ppc.php?Id=$user_data[Id]'class='btn btn-info'>
