...
<body>
    ...
    var message = "NQR dengan nomor ' . $reg_no . ' telah di approve oleh foreman PPC(' . $nm_fm_ppc . '). Klik link ini untuk memeriksa NQR: http://e-learning.stmi.ac.id/mhs/login";
    ...
    if (isset($_POST['tolak'])) {
        ...
        if ($result_rejectfm) {
            ...
            echo '<script>
    var no_reg_sanitized = "' . preg_replace("/[^a-zA-Z0-9]+/", "", $reg_no) . '";
    var message = "NQR dengan nomor ' . $reg_no . ' telah di reject oleh Supervisor PPC(' . $nm_fm_ppc . ').dengan alasan ' . $remark_fm_ppc . ' Klik link ini untuk memeriksa NQR: http://e-learning.stmi.ac.id/mhs/login";
