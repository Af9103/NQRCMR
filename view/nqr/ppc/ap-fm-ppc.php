...
$queryKasir = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE YEAR(dt_op_qa) = $currentYear AND status_ppc IN (2,6) ORDER BY FIELD (status_ppc, 2,6)");
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main id="main" class="main">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item active">
        <a class="nav-link active" aria-current="page" href="ap-fm-ppc.php">
          NQR<span style="font-size: smaller; opacity: 0.7;"> </span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="../../cmr/ppc/ap-fm-cmr-ppc.php">CMR<span
          ...
          <table class="table table-hover text-center" id="ppcTable">
            ...
            <tbody>
              ...
              while ($user_data = mysqli_fetch_array($queryKasir)) {
                ...
                echo "<td><a href='ap-fm-detail-ppc.php?Id=$user_data[Id]'class='btn btn-info'>
<i class='bi-file-check' style='color: white;'></i></a> </td>";
                ...
                while ($userData = mysqli_fetch_assoc($csResult)) {
                  ...
                  $status_ppc = $userData['status_ppc'];
                }
                mysqli_free_result($csResult);
