...
$query = "SELECT * FROM transaksi WHERE 1=1 $dateFilter AND status_ppc IN ($statusString) ORDER BY FIELD(status_ppc, 1, 2, 3, 4, 5, 6, 7, 8)";
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card" onclick="window.location.href='requestppc.php';"
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      $queryJumlahData = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM transaksi WHERE YEAR(dt_op_qa) = $currentYear AND status_ppc IN (1,2)");
            ...
            <!-- Revenue Card -->
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card" onclick="window.location.href='rejectppc.php';"
                style="cursor: pointer;">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      // Melakukan query untuk menghitung jumlah status dengan nilai 2, 3, dan 4
                      $queryJumlahData = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM transaksi WHERE YEAR(dt_op_qa) = $currentYear AND status_ppc IN (6, 7, 8)");
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card" onclick="window.location.href='approveppc.php';"
                style="cursor: pointer;">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      // Melakukan query untuk menghitung jumlah status dengan nilai 2, 3, dan 4
                      $queryJumlahData = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM transaksi WHERE YEAR(dt_op_qa) = $currentYear AND status_ppc IN (3, 4, 5)");
                ...
                <script>
                  ...
                  document.getElementById('thisWeek').addEventListener('click', function () {
                    ...
                    window.location.href =
                      'dasborppc.php?filter=week'; // Redirect dengan filter "week"
                  });
                  ...
                  document.getElementById('thisMonth').addEventListener('click', function () {
                    ...
                    window.location.href =
                      'dasborppc.php?filter=month'; // Redirect dengan filter "month"
                  });
                  ...
                  document.getElementById('thisYear').addEventListener('click', function () {
                    ...
                    window.location.href =
                      'dasborppc.php?filter=year'; // Redirect dengan filter "year"
                  });
...
<i class='bi bi-file-earmark-pdf' style='color: white;'></i></a>";
  ...
  <script>
    $(document).ready(function () {
      ...
      $.fn.dataTable.ext.type.order['status-ppc-pre'] = function (data) {
        switch (data) {
          case '1':
            return 0;
          case '2':
