...
$queryKasir = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE YEAR(dt_op_qa) = $currentYear AND status_vdd IN (2,6) ORDER BY FIELD (status_vdd, 2,6)");
    ...
    <main id="main" class="main">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item active">
                <a class="nav-link active" aria-current="page" href="ap-fm-vdd.php">
                    NQR<span style="font-size: smaller; opacity: 0.7;"> </span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="../../cmr/vdd/ap-fm-cmr-vdd.php">CMR<span
                    ...
                    <table class="table table-hover text-center" id="ppcTable">
                        ...
                        <tbody>
                            ...
                            while ($user_data = mysqli_fetch_array($queryKasir)) {
                              ...
                              echo "<td><a href='ap-fm-detail-vdd.php?Id=$user_data[Id]'class='btn btn-info'>
<i class='bi-file-check' style='color: white;'></i></a> </td>";
                              ...
                              while ($userData = mysqli_fetch_assoc($csResult)) {
                                ...
                                $status_vdd = $userData['status_vdd'];
                              }
                              mysqli_free_result($csResult);
