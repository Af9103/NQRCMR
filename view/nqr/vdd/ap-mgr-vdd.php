...
$queryKasir = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE YEAR(dt_op_qa) = $currentYear AND status_vdd IN (4,8) ORDER BY FIELD (status_vdd, 4,8)");
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main id="main" class="main">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item active">
        <a class="nav-link active" aria-current="page" href="ap-mgr-vdd.php">
          NQR<span style="font-size: smaller; opacity: 0.7;"> </span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="../../cmr/vdd/ap-mgr-cmr-vdd.php">CMR<span
          ...
          <table class="table table-hover text-center" id="ppcTable">
            ...
            <tbody>
              ...
              while ($user_data = mysqli_fetch_array($queryKasir)) {
                ...
                echo "<td><a href='ap-mgr-detail-vdd.php?Id=$user_data[Id]'class='btn btn-info'>
