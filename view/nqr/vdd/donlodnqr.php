...
$queryKasir = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE YEAR(dt_op_qa) = $currentYear AND status_vdd IN (5)");
  ...
  <main id="main" class="main">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item active">
        <a class="nav-link active" aria-current="page" href="donlodnqr.php">
          NQR<span style="font-size: smaller; opacity: 0.7;"> </span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="../../cmr/vdd/donlodcmr.php">CMR<span
    ...
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Download <span>| NQR</span></h5>
        ...
        <table class="table table-hover text-center" id="dasborTable">
          ...
          <tbody>
            ...
            while ($user_data = mysqli_fetch_array($queryKasir)) {
              ...
              echo "<td>";
              echo "<a href='../../../output/NQR2.php?Id={$user_data['Id']}' target='_blank' class='btn btn-danger btn-sm' style='padding: 0.25rem 0.5rem;'>
<i class='bi bi-file-earmark-pdf' style='color: white;'></i></a>";
              echo " "; // Menambahkan spasi antara tombol
              echo "<a href='../../../output/NQR2.php?Id={$user_data['Id']}' download='{$user_data['reg_no']}.pdf' class='btn btn-primary btn-sm download-link' style='padding: 0.25rem 0.5rem;' target='_blank'>
