...
$queryKasir = mysqli_query($koneksi3, "SELECT * FROM transaksi t JOIN status_cmr s ON t.Id = s.Id WHERE YEAR(s.dt_op_qa) = $currentYear AND s.sts_cmr_ppc IN (2,6) ORDER BY FIELD(s.sts_cmr_ppc, 2,6)");
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main id="main" class="main">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item active">
        <a class="nav-link" aria-current="page" href="ap-fm-ppc.php">
          NQR<span style="font-size: smaller; opacity: 0.7;"> </span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link active" href="../../nqr/qa/ap-fm-cmr-ppc.php">CMR<span
          ...
          <table class="table table-hover text-center" id="ppcTable">
            ...
            <tbody>
              ...
              while ($user_data = mysqli_fetch_array($queryKasir)) {
                ...
                echo "<td><a href='ap-fm-cmr-detail-ppc.php?Id=$user_data[Id]'class='btn btn-info'>
