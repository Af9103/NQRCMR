...
<body>
    ...
    var message = "CMR dengan nomor ' . $cmr_no . ' telah di approve oleh Manager PPC(' . $nm_mgr_ppc . '). Klik link ini untuk memeriksa NQR: http://e-learning.stmi.ac.id/mhs/login";
    ...
    var message = "CMR dengan nomor ' . $cmr_no . ' telah di reject oleh Manager PPC(' . $nm_mgr_ppc . ').dengan alasan ' . $remark_mgr_ppc . ' Klik link ini untuk memeriksa CMR: http://e-learning.stmi.ac.id/mhs/login";
