...
<body>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="ap-fm-cmr-ppc.php">List CMR</a></li>
                                ...
                                <fieldset class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="dotc" id="dotc1"
                                                value="1" <?php echo $PayChecked; ?> disabled>
                                            <label class="form-check-label" for="p1">
                                                Pay Compensation
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="dotc" id="dotc2"
                                                value="2" <?php echo $SendChecked; ?> disabled>
    ...
    if (isset($_POST['proses'])) {
        ...
        $result_approvefm = mysqli_query($koneksi3, "UPDATE status_cmr SET dt_fm_ppc='$dt_fm_ppc', nm_fm_ppc='$nm_fm_ppc', sts_cmr_ppc='3', sts_fm_ppc='1' WHERE Id='$Id'");
        if ($result_approvefm) {
    ...
    Swal.fire({
        ...
        text: "CMR dengan nomor ' . $cmr_no . ' telah di-approve oleh ' . $nm_fm_ppc . ' pada ' . $dt_fm_ppc . ' ",
        showConfirmButton: false,
        timer: 2000
    }).then(() => {
        window.location.href = "ap-fm-cmr-ppc.php";
    });
</script>';
        } else {
    ...
    if (isset($_POST['tolak'])) {
        ...
        // Eksekusi query update
        $result_rejectfm = mysqli_query($koneksi3, "UPDATE status_cmr SET dt_fm_ppc='$dt_fm_ppc', nm_fm_ppc='$nm_fm_ppc', remark_fm_ppc='$remark_fm_ppc', remark_ppc='$remark_fm_ppc', sts_cmr_ppc='6',sts_fm_ppc='2' WHERE Id='$Id'");
        if ($result_rejectfm) {
    ...
    Swal.fire({
        ...
        icon: "error",
        title: "CMR Rejected",
        text: "CMR dengan nomor ' . $cmr_no . ' telah di-reject oleh ' . $nm_fm_ppc . ' pada ' . $dt_fm_ppc . ' dengan remark ' . $remark_fm_ppc . '",
        showConfirmButton: false,
        timer: 2000
    }).then(() => {
        window.location.href = "ap-fm-cmr-ppc.php";
