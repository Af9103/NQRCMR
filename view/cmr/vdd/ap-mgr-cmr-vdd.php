...
$queryKasir = mysqli_query($koneksi3, "SELECT * FROM transaksi t JOIN status_cmr s ON t.Id = s.Id WHERE YEAR(s.dt_op_qa) = $currentYear AND s.sts_cmr_vdd IN (4,8) ORDER BY FIELD(s.sts_cmr_ppc, 4,8)");
  ...
  <main id="main" class="main">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item active">
        <a class="nav-link" aria-current="page" href="../../nqr/vdd/ap-spv-vdd.php">
          NQR<span style="font-size: smaller; opacity: 0.7;"> </span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link active" href="ap-mgr-cmr-vdd.php">CMR<span
          ...
          <table class="table table-hover text-center" id="ppcTable">
            ...
            <tbody>
              ...
              while ($user_data = mysqli_fetch_array($queryKasir)) {
                ...
                echo "<td><a href='ap-mgr-cmr-detail-vdd.php?Id=$user_data[Id]'class='btn btn-info'>
