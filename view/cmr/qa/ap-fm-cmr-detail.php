...
<body>
    ...
    if (isset($_POST['proses'])) {
        ...
        var message = "CMR dengan nomor ' . $cmr_no . ' telah di-Approve oleh Foreman QA (' . $nm_fm_qa . '). Klik link ini untuk memeriksa CMR: http://e-learning.stmi.ac.id/mhs/login";
    ...
    var message = "CMR dengan nomor ' . $cmr_no . ' telah di reject oleh Foreman(' . $nm_fm_qa . ').dengan alasan ' . $remark_fm_qa . ' Klik link ini untuk memeriksa CMR: http://e-learning.stmi.ac.id/mhs/login";
