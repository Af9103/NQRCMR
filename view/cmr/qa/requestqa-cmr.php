...
$query1 = mysqli_query($koneksi3, "SELECT * FROM transaksi t INNER JOIN status_cmr s ON t.Id = s.Id WHERE YEAR(s.dt_op_qa) = $currentYear AND s.sts_cmr IN (1)");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="card">
      <div class="card-body">
            ...
            <i class='ri-file-search-line' style='color: white;'></i>
              ...
              if (isset($_SESSION['role']) && ($_SESSION['role'] == 'OPQA' || $_SESSION['role'] == 'admin')) {
                ...
                if ($status == 1 || $status == 9 || $status == 10 || $status == 11) {
                  ...
                  // Hasil enkripsi
                  echo "<a href='edit_cmr.php?Token=" . urlencode($encrypted_token) . "' class='btn btn-success btn-sm' style='padding: 0.25rem 0.5rem;'>
        <i class='ri-edit-2-line' style='color: white;'></i>
              ...
              echo "<a href='CMR1.php?Id={$user_data['Id']}' target='_blank' class='btn btn-warning btn-sm' style='padding: 0.25rem 0.5rem;'>
