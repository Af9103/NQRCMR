...
$queryKasir = mysqli_query($koneksi3, "SELECT * FROM transaksi t JOIN status_cmr s ON t.Id = s.Id WHERE YEAR(s.dt_op_qa) = $currentYear AND s.sts_cmr IN (4,5,12) ORDER BY FIELD(s.sts_cmr, 4,5,12)");
                    ...
                    <table class="table table-hover text-center" id="dasborTable">
                        ...
                        <tbody>
                            ...
                            while ($user_data = mysqli_fetch_array($queryKasir)) {
                              ...
                              $csSql = "SELECT feedbac_ta FROM status_cmr WHERE Id = '{$user_data['Id']}'";

                              $csResult = mysqli_query($koneksi3, $csSql);

                              while ($userData = mysqli_fetch_assoc($csResult)) {
                                // Corrected the variable name inside the array
                                $feedbac_ta = $userData['feedbac_ta'];
                              }
                              ...
                              echo '<strong>feedback</strong>: ' . $feedbac_ta;
                              echo '</div>';
                              echo '</div>';
                              ...
                              switch ($user_data['sts_cmr']) {
                                ...
                                case 12:
                                  ...
                                  break;
                                default:
                                  $status_label = $user_data['sts_cmr'];
                              }
                              ...
                              while ($userData = mysqli_fetch_assoc($csResult)) {
                                ...
                                switch ($user_data['status_ta']) {
                                  case 1:
                                    $status_ta = "Approved by TA";
                                    break;
                                  case 2:
                                    $status_ta = "Rejected by TA";
                                    break;
                                  default:
                                    $status_ta = "";
                                }
                              ...
                              echo "<td><a href='ta-detail.php?Id={$user_data['Id']}' class='btn btn-info'>
